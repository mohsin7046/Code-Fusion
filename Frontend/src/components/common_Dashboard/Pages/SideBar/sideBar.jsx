...
const navigation = [
  { name: "Dashboard", icon: Home, href: "/dashboard" },
  {
    ...
    icon: BarChart2,
    href: "/dashboard/current_interview",
  },
...
const usernavigation = [
  { name: "Dashboard", icon: Home, href: "/user/dashboard" },
  {
    name: "All Interviews",
    icon: Users,
    href: "/user/dashboard/all-interview",
  },
  { name: "Billing", icon: HelpCircle, href: "/user/dashboard/billings" },
  { name: "All Jobs", icon: HelpCircle, href: "/user/dashboard/all-jobs" },
];
        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200">
            {(!isCollapsed || isMobileOpen) && (
              <Link to="/">
                <h1 className="text-xl font-bold text-gray-800">CodeFusion</h1>
              </Link>
            )}
            <button
              onClick={toggleCollapse}
              className="p-1.5 rounded-lg hover:bg-gray-100 focus:outline-none hidden lg:block"
